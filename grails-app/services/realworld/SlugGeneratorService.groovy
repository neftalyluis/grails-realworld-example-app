...
class SlugGeneratorService {
     ...
     * a counter is added.
     *
     * Note: this service uses realworld.SlugCodec for create a slug for a string and realworld.SlugCodec, by
     ...
     */
    String generateSlug(Class theClazz, String property, String value, Boolean strict = false) {
        ...
        def persistentProperty = theClazz.getGormPersistentEntity().getPropertyByName(property)
